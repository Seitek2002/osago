...
const MainFooter = () => {
  return (
    <footer className='py-[40px] text-[#000] text-[14px]'>
      <Container>
        <div className='md:bg-[#E3EFFF] rounded-[16px] p-6 flex flex-col gap-[20px] lg:gap-[40px] gap-2xl lg:flex-row bg-[#dbe4f1] justify-between '>
          ...
          <div className='space-y-2 lg:max-w-[274.33px]'>
            <p>
              Закрытое акционерное общество «Бакай Страхование» (ЗАО «Бакай
              Страхование)
            </p>
            <p>
              Общество с ограниченной ответственностью «Агент Кей Джи» является
              авторизованным представителем (агентом) ЗАО «Бакай Страхование».
            </p>
          </div>

          <div className='space-y-2 w-full lg:max-w-[274.33px]'>
            <p>
              ЗАО «Бакай Страхование» обладает лицензией № 03, номер бланка № 0003
