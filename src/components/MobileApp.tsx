      ...
      <Container>
        <div className='md:flex gap-[40px] justify-center'>
          <div className='flex flex-col  md:w-1/3'>
            <h2 className='text-[32px] font-normal'>Мобильное приложение</h2>
            <p className='text-[15px] mt-2 mb-8'>
              Теперь оформить страховку можно не только дома за компьютером, но
              и в дороге, в очереди, на прогулке, в общественном транспорте — в
              любое время, в любом месте, где есть Интернет.
            </p>
